    ...
    public class WellKnown
    {
        public static readonly Maze Maze = new Maze
        {
            ...
            Board = new Cell[]
            {
                ...
                new Cell { X = 1, Y = 0, IsLeftActive = true, IsRightActive = true, IsLowerActive = false, IsUpperActive = true },
                new Cell { X = 1, Y = 1, IsLeftActive = true, IsRightActive = false, IsLowerActive = true, IsUpperActive = true },
                ...
                new Cell { X = 2, Y = 1, IsLeftActive = true, IsRightActive = true, IsLowerActive = false, IsUpperActive = true },
                new Cell { X = 2, Y = 2, IsLeftActive = true, IsRightActive = false, IsLowerActive = true, IsUpperActive = true },
                ...
                new Cell { X = 3, Y = 2, IsLeftActive = true, IsRightActive = true, IsLowerActive = false, IsUpperActive = true },
                new Cell { X = 3, Y = 3, IsLeftActive = true, IsRightActive = false, IsLowerActive = true, IsUpperActive = true },
                ...
                new Cell { X = 4, Y = 3, IsLeftActive = true, IsRightActive = true, IsLowerActive = false, IsUpperActive = true },
                new Cell { X = 4, Y = 4, IsLeftActive = true, IsRightActive = true, IsLowerActive = true, IsUpperActive = true }
            }
        };
    }
}
